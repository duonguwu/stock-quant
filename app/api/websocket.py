...
class ConnectionManager:
    ...
    async def broadcast(self, message: Dict[str, Any]):
        ...
        if disconnected_connections:
            logger.info(
                f"Cleaned up {len(disconnected_connections)} disconnected connections")

    async def broadcast_to_group(
            self, message: Dict[str, Any], group_filter: callable = None):
        ...
        for connection in self.active_connections:
            ...
            if group_filter and not group_filter(
