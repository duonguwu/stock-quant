...
class SimpleDataFetcher:
    ...
    def get_current_15m_bar_time(self) -> datetime:
        ...
        print(f"🕐 Current 15m bar time: {current_bar.strftime('%Y-%m-%d %H:%M:%S')}")
        return current_bar
    ...
    def calculate_lookback_period(self, bars: int = 600) -> tuple:
        ...
        print(f"📅 Lookback period: {start_date.date()} to {end_date.date()} ({days_needed} days)")
    ...
    def fetch_historical_data(self, 
        ...
        if self.use_real_data:
            ...
            return self._generate_mock_data(tickers, start_date, end_date, bars)
    ...
    def _generate_mock_data(self, 
        ...
        data = []
        base_prices = {'CTG': 25000, 'MBB': 23000, 'ACB': 21000, 'QNS': 45000, 'MSH': 120000}
        ...
        while current_time <= end_date and len(timestamps) < bars:
            ...
            if (9 <= current_time.hour < 11.5) or (13 <= current_time.hour < 15):
